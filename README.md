# next-app-router-output-crud-auth-api-features
...
DBMS: Postgres
host: 127.0.0.1
database: NEXT_APP_ROUTER_OUTPUT_CRUD_AUTH_FEATURES_API_DB
user: user
password: pass
port: 5432
```
...
- バックエンド: next-app-router-output-crud-auth-features-api-backend
- DB: postgres:17.2
